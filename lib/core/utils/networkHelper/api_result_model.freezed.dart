...
mixin _$ApiResult<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(Failure errorResult) error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
  TResult? whenOrNull<TResult extends Object?>({
    TResult? Function(T data)? success,
    TResult? Function(Failure errorResult)? error,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$ErrorImpl<T> implements Error<T> {
  const _$ErrorImpl({required this.errorResult});

  @override
  final Failure errorResult;

  @override
  String toString() {
    return 'ApiResult<$T>.error(errorResult: $errorResult)';
  }
...
abstract class Error<T> implements ApiResult<T> {
  const factory Error({required final Failure errorResult}) = _$ErrorImpl<T>;

  Failure get errorResult;
  @JsonKey(ignore: true)
  _$$ErrorImplCopyWith<T, _$ErrorImpl<T>> get copyWith =>
      throw _privateConstructorUsedError;
}
